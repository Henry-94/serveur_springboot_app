...
public class NotificationController {
    ...
    @DeleteMapping("/invitations/{id}") public void deleteGroup(@PathVariable Long id, @AuthenticationPrincipal UserDetails u) { service.deleteGroup(id, u.getUsername()); }
    ...
    @DeleteMapping("/event-invitations/{id}") public void deleteEvent(@PathVariable Long id, @AuthenticationPrincipal UserDetails u) { service.deleteEvent(id, u.getUsername()); }
